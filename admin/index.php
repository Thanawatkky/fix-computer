...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="index.php?p=fix">
                    <i class="fas fa-fw fa-wrench"></i>
                    <span>รายการรอซ่อม</span>
                </a>
                <a class="nav-link collapsed" href="index.php?p=history">
                    <i class="fas fa-fw fa-history"></i>
                    <span>ประวัติการซ่อม</span>
                </a>
                <a class="nav-link collapsed" href="index.php?p=token">
                    <i class="fas fa-fw fa-history"></i>
    ...
    <script>
            ...
            let id = $(this).data("id");
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        $.ajax({
                                url: "../api/line_notify.php?fix_id="+id,
                                dataType: "html",
                                type: "post",
        ...
        $(document).on("click","#btn-comcheck",function(){
                let id = $(this).data("id");
                    $.ajax({
                        url: "../api/ac_fix-com.php?ac=to2",
                        data:{
                            fix_id: id
                        },
                        dataType: "html",
        ...
        $(document).on("click","#btn-disable",function(){
            ...
            $(document).on("submit","#frm_token",function() {
               let url = $(this).attr("action");
               let data = new FormData(this);
               $.ajax({
                url: url,
